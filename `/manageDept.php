...
if (isset($_POST['submit'])) {
  ...
  $dept=$_POST['dept'];
            ...
            $sql=mysqli_query($con,"INSERT INTO `dept`( `dept`) VALUES ('$dept')");
            if($sql){	
...
if (isset($_POST['update'])) {
  ...
  $dept=$_POST['dept'];
            ...
            $sql=mysqli_query($con,"UPDATE `dept` SET `dept`='$dept' WHERE id='$id'");
            if($sql){	
...
if(isset($_GET['del']))
		  {
		         $ssq= mysqli_query($con,"delete from dept where id = '".$_GET['id']."'");
             if($ssq){	
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary card-outline">
              <div class="table-top" >
                <h2 class="table-title">List of Department</h2>
              ...
              <div class="card-body one">
                ...
                <thead class="table table-secondary">
                  ...
                  <td><span id="dept<?php echo $row['id']; ?>"><?php echo $row['dept']; ?></span></td>
    ...
    <?php include('popup/modal_dept.php'); ?>
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal row-fluid" name="asd" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="title" class="col-form-label">Department Name:</label>
            <input type="text" class="form-control" id="title" name="dept" placeholder="e.g : P1">
          </div>
