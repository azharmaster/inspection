    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <?php   
                  // $f1="00:00:00";
                  // $techactive=date('Y-m-d')." ".$f1;
                $ret=mysqli_query($con,"SELECT COUNT(id) AS pr FROM `user`");
                $num = mysqli_fetch_array($ret); echo $num['pr'];  ?>
                </h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <h3> 
                <?php   
                $ret=mysqli_query($con," SELECT  COUNT(id) as tot FROM category");
              ...
              <a href="manageTask.php?id=<?php echo $date ?>&sortdate" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <h3> 
                <?php   
                $ret=mysqli_query($con," SELECT  COUNT(id) as tot FROM vessel ");
                $num = mysqli_fetch_array($ret); echo $num['tot'];  ?>
                </h3>
                <p>TOTAL VESSEL</p>
              </div>
              ...
              <a href="manageTask.php?id=<?php echo $date1d ?>&sortdate" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>

          <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box " style="background-color: #28ff42;">
              <div class="inner">
                <h3> 
                <?php   
                $ret=mysqli_query($con," SELECT  COUNT(id) as tot FROM dept ");
                $num = mysqli_fetch_array($ret); echo $num['tot'];  ?>
                </h3>
              ...
              <a href="manageTask.php?id=3&sort" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box " style="background-color: #FFD919" >
              ...
              <h3> 
                <?php   
                $ret=mysqli_query($con," SELECT  COUNT(id) as tot FROM inspection ");
                $num = mysqli_fetch_array($ret); echo $num['tot'];  ?>
                </h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger" >
              ...
              <h3> 
                <?php   
                $ret=mysqli_query($con," SELECT  COUNT(id) as tot FROM observe WHERE status = 0 ");
                $num = mysqli_fetch_array($ret); echo $num['tot'];  ?>
                </h3>
          ...
          <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box " style="background-color:#19B2FF">
              <div class="inner">
              <h3> 
                <?php   
                $ret=mysqli_query($con," SELECT  COUNT(id) as tot FROM observe WHERE status = 1 ");
                $num = mysqli_fetch_array($ret); echo $num['tot'];  ?>
                </h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box " style="background-color:#FF55F5">
              ...
              <h3> 
                <?php   
                $ret=mysqli_query($con," SELECT  COUNT(id) as tot FROM observe");
                $num = mysqli_fetch_array($ret); echo $num['tot'];  ?>
                </h3>
        ...
        <div class="row">
          ...
          <section class="col-lg-6 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                ...
                $query=mysqli_query($con,"SELECT * FROM insp ORDER BY id DESC  limit 5");
                $cnt=1;
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Finding / Observation / Action Item</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body p-0">
              <table class="table table-striped">
                ...
                $query=mysqli_query($con,"SELECT * FROM observe ORDER BY id DESC  limit 5");
                $cnt=1;
                while($row=mysqli_fetch_array($query))
                { 
...
'<?php echo date('F');?>'],
      ...
      datasets: [
        ...
        <?php  
          ...
          $que1=mysqli_query($con,"SELECT COUNT(id) as ki FROM insp WHERE  cdate between '$abulan4' AND '$bbulan4'");
          $rw1=mysqli_fetch_array($que1); $bulan4=$rw1['ki'];

          $que2=mysqli_query($con,"SELECT COUNT(id) as ki FROM insp WHERE  cdate between '$abulan3' AND '$bbulan3'");
          $rw1=mysqli_fetch_array($que2); $bulan3=$rw1['ki'];
          
          $que3=mysqli_query($con,"SELECT COUNT(id) as ki FROM insp WHERE  cdate between '$abulan2' AND '$bbulan2'");
          $rw1=mysqli_fetch_array($que3); $bulan2=$rw1['ki'];

          $que4=mysqli_query($con,"SELECT COUNT(id) as ki FROM insp WHERE  cdate between '$abulan1' AND '$bbulan1'");
          $rw1=mysqli_fetch_array($que4); $bulan1=$rw1['ki'];

          $que5=mysqli_query($con,"SELECT COUNT(id) as ki FROM insp WHERE  cdate between '$abulan0' AND '$bbulan0'");
         ...
         <?php  
          ...
          $que1=mysqli_query($con,"SELECT COUNT(id) as ki FROM observe WHERE  cdate between '$abulan4' AND '$bbulan4'");
          $rw1=mysqli_fetch_array($que1); $bulan4=$rw1['ki'];

          $que2=mysqli_query($con,"SELECT COUNT(id) as ki FROM observe WHERE  cdate between '$abulan3' AND '$bbulan3'");
          $rw1=mysqli_fetch_array($que2); $bulan3=$rw1['ki'];
          
          $que3=mysqli_query($con,"SELECT COUNT(id) as ki FROM observe WHERE  cdate between '$abulan2' AND '$bbulan2'");
          $rw1=mysqli_fetch_array($que3); $bulan2=$rw1['ki'];

          $que4=mysqli_query($con,"SELECT COUNT(id) as ki FROM observe WHERE  cdate between '$abulan1' AND '$bbulan1'");
          $rw1=mysqli_fetch_array($que4); $bulan1=$rw1['ki'];

          $que5=mysqli_query($con,"SELECT COUNT(id) as ki FROM observe WHERE  cdate between '$abulan0' AND '$bbulan0'");
          $rw1=mysqli_fetch_array($que5); $bulan0=$rw1['ki'];
