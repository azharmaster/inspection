...
if (isset($_POST['submit'])) {
  ...
  // foreach ($_FILES['upload']['name'] as $key => $name){
	...
	// }
            ...
            $sql=mysqli_query($con,"INSERT INTO `category`( `category`,`descr`) VALUES ('$category','$desc')");
            if($sql){	
...
if (isset($_POST['update'])) {
  ...
  $desc=$_POST['desc'];
            ...
            $sql=mysqli_query($con,"UPDATE `category` SET `category`='$category',`descr`='$desc' WHERE id='$id'");
            if($sql){	
...
if(isset($_GET['del']))
		  {
		         $ssq= mysqli_query($con,"delete from category where id = '".$_GET['id']."'");
             if($ssq){	
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary card-outline">
              <div class="table-top" >
                <h2 class="table-title">List of Category</h2>
    ...
    <?php include('popup/modal_category.php'); ?>
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal row-fluid" name="asd" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" name="category" placeholder="e.g : P1">
          </div>
          <div class="form-group">
