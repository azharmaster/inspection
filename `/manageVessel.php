...
if (isset($_POST['submit'])) {
  ...
  // foreach ($_FILES['upload']['name'] as $key => $name){
	...
	// 	mysqli_query($con,"INSERT INTO `image_issue`( `rand_id`, `image`) VALUES ('$rand','$file')");
	// }

            $sql=mysqli_query($con,"INSERT INTO `vessel`( `name`,`descr`) VALUES ('$vessel','$desc')");
            if($sql){	
...
if (isset($_POST['update'])) {
  ...
  $desc=$_POST['desc'];
            ...
            $sql=mysqli_query($con,"UPDATE `vessel` SET `name`='$name',`descr`='$desc' WHERE id='$id'");
            if($sql){	
...
if(isset($_GET['del']))
		  {
		         $ssq= mysqli_query($con,"delete from vessel where id = '".$_GET['id']."'");
             if($ssq){	
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="page-title">Vessel Management </h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary card-outline">
              <div class="table-top" >
                <h2 class="table-title">List of Vessel</h2>
              ...
              <div class="card-body one">
                ...
                <thead class="table table-secondary">
                  ...
                  <!-- <span hidden id="project<?php echo $row['id']; ?>"><?php echo $idp; ?></span>
                 
                  <span hidden id="status<?php echo $row['id']; ?>"><?php echo $row['status_id']; ?></span> -->

               
                  <td><span id="vessel<?php echo $row['id']; ?>"><?php echo $row['name']; ?></span></td>
                  <td><span id="desc<?php echo $row['id']; ?>"><?php echo $row['descr']; ?></span></td>
                     ...
                     <td> <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
                                    <!-- <a class="dropdown-item" href="issues-detail.php?id=<?php //echo $row['rand_id']; ?>"><span class="fas fa-eye text-warning"></span> View</a>
    ...
    <?php include('popup/modal_vessel.php'); ?>
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal row-fluid" name="asd" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="title" class="col-form-label">Vessel Name:</label>
            <input type="text" class="form-control" id="title" name="vessel" placeholder="e.g : Perkasa">
          </div>
          <div class="form-group">
