            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body one">
                ...
                <thead class="table table-secondary">
                  ...
                  $query=mysqli_query($con,"SELECT DISTINCT i.* FROM observe o JOIN insp i ON o.insp_id=i.id WHERE o.dept_id='$dept';");
                  $cnt=1;
                  while($row=mysqli_fetch_array($query))
                  {

                    $quy1=mysqli_query($con,"SELECT COUNT(id) total FROM observe WHERE status=0 AND dept_id='$dept' AND insp_id='".$row['id']."'  ");
                    $rw1=mysqli_fetch_array($quy1);

                    $quy2=mysqli_query($con,"SELECT COUNT(id) total FROM observe WHERE status=1 AND dept_id='$dept' AND insp_id='".$row['id']."'  ");
                  ...
                  <td><span class="badge badge-danger"><?php echo $rw1['total'] ?> Open</span> <br><span class="badge badge-success"><?php echo $rw2['total'] ?> Close</span></td>
                     ...
                     <td> <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
                          ...
                          <a class="dropdown-item" href="insp-details.php?id=<?php echo $row['id'] ?>"><span class="fas fa-eye text-warning"></span> View</a>
